...
(14530, 2),  -- Heavy Runecloth Bandage (First Aid 225)
-- =============================================
...
(18856, 3),  -- Insignia of the Alliance (Mage)
(18857, 3),  -- Insignia of the Alliance (Rogue)
(18858, 3),  -- Insignia of the Alliance (Priest)
(18859, 3),  -- Insignia of the Alliance (Druid)
(18862, 3),  -- Insignia of the Alliance (Paladin)
(18863, 3),  -- Insignia of the Alliance (Hunter)
(18864, 3),  -- Insignia of the Alliance (Warlock)
-- Class-specific insignias (Horde)
(18845, 3),  -- Insignia of the Horde (Rogue)
(18846, 3),  -- Insignia of the Horde (Hunter)
(18849, 3),  -- Insignia of the Horde (Mage)
(18850, 3),  -- Insignia of the Horde (Warlock)
(18851, 3),  -- Insignia of the Horde (Priest)
(18852, 3),  -- Insignia of the Horde (Druid)
(18853, 3),  -- Insignia of the Horde (Shaman)
-- Battle Standards
...
CREATE TABLE IF NOT EXISTS `custom_twinkmaster_original_prices` (
  ...
  PRIMARY KEY (`entry`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Backup of original item prices before Twink Master zeroed them';

INSERT IGNORE INTO `custom_twinkmaster_original_prices` (`entry`, `original_buy_price`, `original_sell_price`)
SELECT it.`entry`, it.`BuyPrice`, it.`SellPrice`
FROM `item_template` it
JOIN `custom_twinkmaster_vendor_categories` vc ON it.`entry` = vc.`item`;

UPDATE `item_template` it
JOIN `custom_twinkmaster_vendor_categories` vc ON it.`entry` = vc.`item`
SET it.`BuyPrice` = 0, it.`SellPrice` = 0;

-- ============================================================
-- NPC Vendor Inventory (all categories combined)
-- ============================================================
